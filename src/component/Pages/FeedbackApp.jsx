...
export default function FeedbackApp() {
  return (
     ...
     <>
     <HeaderApp /><main className="pt-32 pb-xl px-6 max-w-[1280px] mx-auto">
    ...
    <section className="lg:col-span-5 lg:sticky lg:top-32">
      ...
      <div className="bg-white p-lg rounded-xl shadow-lg border border-outline-variant/30">
        <form action="#" className="space-y-md">
          ...
          <div>
            <label
              className="font-label-sm text-label-sm text-on-surface block mb-xs"
              htmlFor="review"
            >
              Your Review
            </label>
            <textarea
              className="w-full bg-surface-container-low border border-outline-variant rounded-lg p-md focus:ring-2 focus:ring-secondary focus:border-secondary transition-all outline-none text-body-md"
              id="review"
          ...
          <div className="grid grid-cols-2 gap-md">
            <div>
              ...
              <input
                className="w-full bg-surface-container-low border border-outline-variant rounded-lg p-md focus:ring-2 focus:ring-secondary focus:border-secondary transition-all outline-none"
                id="name"
